...
<div class="reference">
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_javascript-types.svg" alt="JavaScript data types." width="900px" height="auto" align-items="center" />
  </div>
  ...
  until they incorporated `BigInt` as a **numeric data type** intended to address that problem.
  ...
  **Note**: Detailed information in the following section:
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_string-native-example.svg" alt="String native example." width="900px" height="auto" align-items="center" />
  </div>
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_boxing-example.svg" alt="Boxing example." width="300px" height="auto" align-items="center" />
  </div>
  ...
  **Note**: variables don't have types. Only values do. When using `typeof` against a variable, it is like asking: "What's the type of the 
