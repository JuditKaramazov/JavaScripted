...
<div class="reference">
  ...
  **call-site**: this is, the location where a function is called. It can be determined by looking at 
  ...
  **Note**: Remember that the call-stack can be viewed in the browser dev tools. Set a breakpoint and refresh 
  the page; the debugger will pause at this exact line. Then, it will display the current **call-stack**. The 
  second item from the top will be the **call-site**.
  ...
  **No such bridge is possible**. You can't use a `this` reference to look something up in a scope. 
  ...
  <div style="display: flex; justify-content: center; padding-top: 1rem;">
    <img src="src/content/images/_arrow-function.svg" alt="Arrow function visual example." width="270px" height="auto" align-items="center" />
  </div>
