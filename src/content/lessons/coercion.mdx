...
<div class="reference">
  ...
  **Note**: Whenever coercion occurs, 1 or more internal operations, known as abstract operations, are performed. 
  ...
  <div style="display: flex; justify-content: center; padding-top: 1rem;">
    <img src="src/content/images/_language-metaphor.svg" alt="Translation from one language to another visual asset." width="150px" height="auto" align-items="center" />
  </div>
