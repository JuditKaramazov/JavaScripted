...
<div class="reference">
  ...
  **Note**: If you are unfamiliar with the terminology below, check out:
  ...
  <div style="display: flex; justify-content: center; padding-top: 1rem;">
    <img src="src/content/images/_library-metaphor.svg" alt="Pile of books and coffee on top visual asset." width="150px" height="auto" align-items="center" />
  </div>
  ...
  **Metaphor time:**
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_var-hoisting.svg" alt="Examples of var hoisting." width="600px" height="auto" align-items="center" />
  </div>
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_tdz-example.svg" alt="Examples of TDZ." width="500px" height="auto" align-items="center" />
  </div>
