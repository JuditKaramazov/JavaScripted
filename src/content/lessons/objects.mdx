...
<div class="reference">
  ...
  | 2        | Is the property a __data descriptor__ with writable of **false**? Silently fail in non-strict mode, or throw TypeError in strict mode.                |
  ...
  **accessor descriptor** (as opposed to a **data descriptor**).
  ...
  <div style="display: flex; justify-content: center;">
    <img src="src/content/images/_loop.svg" alt="Iteration loop." width="200px" height="auto" align-items="center" />
  </div>
  ...
  ![Shallow versus deep.](src/content/images/_shallow-deep.svg)
