...
<div class="reference">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Build a frame containing a <span class="font-bold">label or read-only textfield</span> and a <b>button</b>.
  
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Initially, the <b>value</b> in the textfield is <b>0</b>.
  
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Each click of the button <b>increases the value</b> in textfield by 1. 
  ...
  First, let's introduce the <b>HTML</b> section and its <b>corresponding styles</b> for a simple counter: 
  ...
  */
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Initially, <b>both textfields</b> are empty.
