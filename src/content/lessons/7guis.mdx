...
<div class="reference">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Build a frame containing a <strong>label or read-only textfield</strong> and a <strong>button</strong>.
  
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Initially, the <strong>value</strong> in the textfield is <strong>0</strong>.
  
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Each click of the button <strong>increases the value</strong> in textfield by 1. 
  ...
  First, let's introduce the <strong>HTML</strong> section and its <strong>corresponding styles</strong> for a simple counter: 
  ...
  complicated. For now, what matters is that they 
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;▪ Initially, <strong>both textfields</strong> are empty.
