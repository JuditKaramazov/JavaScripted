...
<div class="reference">
  ...
  */
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;▪ When the “return flight” <span class="font-bold">date is strictly before time</span>, it's not possible to submit.

  &nbsp;&nbsp;&nbsp;&nbsp;▪ When there is a <span class="font-bold">wrong-formatted date</span>, then it is colored red and the submit button is disabled.
